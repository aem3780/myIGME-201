    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            linkedListNode = linkedList.Find("the");
            ...
            {
                linkedList.AddAfter(linkedListNode, "brown");
                linkedList.AddAfter(linkedListNode, "quick");
            }
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            {
                linkedList.AddAfter(linkedListNode1, "in");
                linkedList.AddAfter(linkedListNode1, "rain");
            }
            ...
            {
                linkedList.AddBefore(linkedListNode1, "mainly");
            }
            ...
            {
                linkedList.AddAfter(linkedListNode1, "plain");
            }
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            {
                anagram.AddBefore(linkedListNode1, "I");
            }
            ...
            {
                anagram.AddBefore(linkedListNode1, "R");
            }
            ...
            {
                anagram.AddBefore(linkedListNode1, "T");
            }
            linkedListNode1 = anagram.Find("O");
            if (linkedListNode1 == null)
            {
            ...
            {
                anagram.AddBefore(linkedListNode1, "Y");
            }
            ...
            {
                anagram.AddBefore(linkedListNode1, "O");
            }
