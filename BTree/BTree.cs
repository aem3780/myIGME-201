...
namespace BTree
{
    public partial class BTreeForm : Form
    {
        ...
        private void Exercise3__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            const string original = "ALLIEMAUS";
        ...
        private void Exercise4__Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 16; ++i)
            {
                string rand = new string(original.ToCharArray().
                OrderBy(s => (num.Next(2) % 2) == 0).ToArray());
                node = new BTree(rand, root, false);
